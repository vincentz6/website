...
export const projects = [
    {
        title: "Chef Claude",
        description: "A web application that uses Mistral AI to generate custom recipes based on ingredients provided by the user. Built with React.js and deployed on Netlify, the app allows users to input the ingredients they have on hand and receive recipe suggestions they can create using those ingredients.",
        image: chef,
        link: "https://github.com/vincentz6"
    },
    {
        title: "#VANLIFE",
        description: "A van rental service simulation where users can browse available vans. Built using React.js and Firebase, this project was developed to gain hands-on experience with React Router for client-side routing and Firebase for backend services including authentication and database management.",
        image: vans,
        link: "https://github.com/vincentz6"
    },
    {
